package Applications.CnacMasterTester;
...
public class CNAC_Smoke_Test
{
    ...
    ****************/
    ...
    public void testCnacSmokeTest()
    {
        ...
        String singleLimitForLiabilityCoverage = "1,000,000";
        ...
        String stateForHiredAutoCoverage = "IL";
        String coverageForUninsuredMotoristHiredAuto = "Combined Single Limit";
        String singleLimitForUninsuredMotoristHiredAuto = "1,000,000";
        String singleLimitForUnderinsuredMotoristHiredAuto = "1,000,000";
        String coverageForUninsuredMotoristNonOwnedAuto = "Combined Single Limit";
        String singleLimitForUninsuredMotoristNonOwnedAutoCoverage = "1,000,000";
        String singleLimitForUnderinsuredMotoristNonOwnedAutoCoverage = "1,000,000";
        ...
        CNAC_User.Policy_Coverage_Page.selectSingleLimitForLiabilityCoverage(singleLimitForLiabilityCoverage);
        CNAC_User.Policy_Coverage_Page.toggleHiredAutoCoverage();
        CNAC_User.Policy_Coverage_Page.selectStateForHiredAutoCoverage(stateForHiredAutoCoverage);
        CNAC_User.Policy_Coverage_Page.selectUninsuredMotoristCoverageForHiredAuto(coverageForUninsuredMotoristHiredAuto);
        CNAC_User.Policy_Coverage_Page.selectSingleLimitUninsuredMotoristForHiredAuto(singleLimitForUninsuredMotoristHiredAuto);
        CNAC_User.Policy_Coverage_Page.toggleIfAnyForHiredAutoCoverage();
        CNAC_User.Policy_Coverage_Page.selectSingleLimitUnderinsuredMotoristForHiredAuto(singleLimitForUnderinsuredMotoristHiredAuto);
        CNAC_User.Policy_Coverage_Page.clickSaveForHiredAutoCoverage();
        CNAC_User.Policy_Coverage_Page.toggleNonOwnedAutoCoverage();
        CNAC_User.Policy_Coverage_Page.selectUnderinsuredMotoristNonOwnedAutoCoverage(coverageForUninsuredMotoristNonOwnedAuto);
        CNAC_User.Policy_Coverage_Page.selectSingleLimitForUninsuredMotoristNonOwnedAutoCoverage(singleLimitForUninsuredMotoristNonOwnedAutoCoverage);
        CNAC_User.Policy_Coverage_Page.selectSingleLimitForUnderinsuredMotoristNonOwnedAutoCoverage(singleLimitForUnderinsuredMotoristNonOwnedAutoCoverage);
        CNAC_User.Policy_Coverage_Page.toggleBroadFormEndorsementPlus();
        ...
        CNAC_User.Submission_Status_Page.switchToMainIFrame();
