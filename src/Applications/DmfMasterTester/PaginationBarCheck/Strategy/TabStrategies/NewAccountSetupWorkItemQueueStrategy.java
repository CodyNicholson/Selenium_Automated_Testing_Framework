 ...
 */
public class NewAccountSetupWorkItemQueueStrategy implements PaginationTabStrategy{

    /*************
     *   XPaths   *
     *************/

    String desktopWestTab = "//span[@id = 'westPanel-outerCt']//div[@id = 'Desktop:MenuLinks-body']//span[text() = 'New Account Setup Work Item Queue']";

    String pageNumber = "//input[@id = 'CNADesktopWorkItemQueues:DesktopAssignableWorkItemQueuesScreen:CNADesktopAssignableWorkItemsLV:_ListPaging-inputEl']";
    ...
    String secondElementEntry = "//table[starts-with(@id, 'gridview-')] //tr[1] //td[4]";
