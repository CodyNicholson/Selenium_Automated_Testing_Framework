 ...
 */
public class MySubmissionsStrategy implements PaginationTabStrategy{

    /*************
     *   XPaths   *
     *************/

    String desktopWestTab = "//span[@id = 'westPanel-outerCt']//div[@id = 'Desktop:MenuLinks-body']//span[text() = 'My Submissions']";

    String pageNumber = "//input[@id = 'DesktopSubmissions:DesktopSubmissionsScreen:DesktopSubmissionsLV:_ListPaging-inputEl']";
