 ...
 */
public class NASSubmissionStatusStrategy implements PaginationTabStrategy{

    /*************
     *   XPaths   *
     *************/

    String desktopWestTab = "//span[@id = 'westPanel-outerCt']//div[@id = 'Desktop:MenuLinks-body']//span[text() = 'NAS Submission Status']";

    String pageNumber = "//input[@id = 'CNADesktopNASSubmission:NASSubmissionScreen:CNADesktopNASSubmissionLV:_ListPaging-inputEl']";
    ...
    String secondElementEntry = "//table[starts-with(@id, 'gridview-')] //tr[1] //td[10]";
